...
namespace GroboTrace.Mono.Cecil.Cil
{
    ...
    public struct OpCode : IEquatable<OpCode>
    {
        ...
        public string Name { get { return OpCodeNames.names[(int)Code]; } }

        public int Size { get { return Op1 == 0xff ? 1 : 2; } }

        public byte Op1 { get; }

        public byte Op2 { get; }

        public short Value { get { return Op1 == 0xff ? Op2 : (short)((Op1 << 8) | Op2); } }

        public Code Code { get { return (Code)code; } }

        public FlowControl FlowControl { get { return (FlowControl)flow_control; } }

        public OpCodeType OpCodeType { get { return (OpCodeType)opcode_type; } }

        public OperandType OperandType { get { return (OperandType)operand_type; } }

        public StackBehaviour StackBehaviourPop { get { return (StackBehaviour)stack_behavior_pop; } }
