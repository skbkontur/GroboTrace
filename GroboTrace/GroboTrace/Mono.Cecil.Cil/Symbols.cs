...
namespace GroboTrace.Mono.Cecil.Cil {
	...
	public struct InstructionSymbol {
		...
		public InstructionSymbol (int offset)
		{
			this.Offset = offset;
		}
	}
	...
	static class SymbolProvider {
		...
		static readonly string symbol_kind = Type.GetType ("GroboTrace.Mono.Runtime") != null ? "Mdb" : "Pdb";
		...
		static SR.AssemblyName GetPlatformSymbolAssemblyName ()
		{
			...
			var name = new SR.AssemblyName {
				Name = "GroboTrace.Mono.Cecil." + symbol_kind,
		...
		{
			return "GroboTrace.Mono.Cecil." + symbol_kind + "." + symbol_kind + name;
		}
