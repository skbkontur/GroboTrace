            ...
            foreach (var instruction in self.Instructions)
            {
                ...
                switch (instruction.OpCode.Code)
                {
                    case Code.Ldarg_0:
                        ...
                        break;
                    case Code.Ldarg_1:
                        ExpandMacro(instruction, OpCodes.Ldarg, 1);
                        break;
                    case Code.Ldarg_2:
                        ExpandMacro(instruction, OpCodes.Ldarg, 2);
                        break;
                    case Code.Ldarg_3:
                        ExpandMacro(instruction, OpCodes.Ldarg, 3);
                        break;
                    case Code.Ldloc_0:
                        ExpandMacro(instruction, OpCodes.Ldloc, 0);
                        break;
                    case Code.Ldloc_1:
                        ExpandMacro(instruction, OpCodes.Ldloc, 1);
                        break;
                    case Code.Ldloc_2:
                        ExpandMacro(instruction, OpCodes.Ldloc, 2);
                        break;
                    case Code.Ldloc_3:
                        ExpandMacro(instruction, OpCodes.Ldloc, 3);
                        break;
                    case Code.Stloc_0:
                        ExpandMacro(instruction, OpCodes.Stloc, 0);
                        break;
                    case Code.Stloc_1:
                        ExpandMacro(instruction, OpCodes.Stloc, 1);
                        break;
                    case Code.Stloc_2:
                        ExpandMacro(instruction, OpCodes.Stloc, 2);
                        break;
                    case Code.Stloc_3:
                        ExpandMacro(instruction, OpCodes.Stloc, 3);
                        break;
                    case Code.Ldarg_S:
