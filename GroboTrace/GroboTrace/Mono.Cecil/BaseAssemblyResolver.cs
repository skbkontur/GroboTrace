...
namespace GroboTrace.Mono.Cecil {
	...
	public abstract class BaseAssemblyResolver : IAssemblyResolver {
		...
		static readonly bool on_Mono = Type.GetType ("GroboTrace.Mono.Runtime") != null;
		...
		static Collection<string> GetDefaultMonoGacPaths ()
		{
			...
			var gac_paths_env = Environment.GetEnvironmentVariable ("GroboTrace.Mono_GAC_PREFIX");
			...
			foreach (var prefix in prefixes) {
				...
				var gac_path = Path.Combine (Path.Combine (Path.Combine (prefix, "lib"), "GroboTrace.Mono"), "gac");
